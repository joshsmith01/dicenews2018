<div id="employers_millennial" class="top-employers employers_millennial hidden">
    <div class="grid-x">
        <div class="small-12 cell">
            <h3><?php _e( 'Millennial Top 10', 'dicenews2015' ); ?> </h3>
            <p><?php _e( 'The 10 most popular companies that US-based Millennial professionals would ideally like to work for.', 'dicenews2015' ); ?>
...
<div class="grid-x">
    <div class="small-12 cell">
        <h4><?php _e( 'Employer Rankings – Millennial Top 10', 'dicenews2015' ); ?></h4>
        <div class="ranked-employers">
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-logo">
                        <img width="150" height="150" src="<?php echo get_bloginfo( 'wpurl' ); ?>/wp-content/uploads/2017/09/Amazon-150x150.png" class="attachment-thumb size-thumb" alt="Accenture logo">
                    </div>
                    <div class="employer-info">
                        <div class="employer-name font-headline">
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <a href="https://www.dice.com/company/10106525" target="_blank">
                                <strong><?php _e( 'Deloitte', 'dicenews2015' ); ?></strong>
                            </a>
                        </div>
                    </div>
                    <div class="employer-jobs">
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <strong><a href="https://www.dice.com/company/ciscobot" target="_blank"><?php _e( 'Cisco Systems', 'dicenews2015' ); ?></a></strong>
                        </div>
                    </div>
                    <div class="employer-jobs">
                        <a class="btn btn-block btn-efc-secondary nav-track"
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <a href="https://www.dice.com/company/delliirc" target="_blank"><strong><?php _e( 'Dell', 'dicenews2015' ); ?></strong></a>
                        </div>
                    </div>
                    <div class="employer-jobs">
                        <a class="btn btn-block btn-efc-secondary nav-track"
