<div id="employers_baby-boomer" class="top-employers employers_baby-boomer hidden">
    <div class="grid-x">
        <div class="small-12 cell">
            <h3><?php _e( 'Baby Boomer Top 10', 'dicenews2015' ); ?></h3>
            <p><?php _e( 'The 10 most popular companies that US-based baby boomer professionals would ideally like to work for.', 'dicenews2015' ); ?>
            </p>
...
<div class="grid-x">
    <div class="small-12 cell">
        <h4><?php _e( 'Employer Rankings – Baby Boomer Top 10', 'dicenews2015' ); ?></h4>
        <div class="ranked-employers">
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <strong><a href="https://www.dice.com/company/10285903" target="_blank"><?php _e( 'AT&T', 'dicenews2015' ); ?></a></strong>
                        </div>
                    </div>
                    <div class="employer-jobs">
                        <a class="btn btn-block btn-efc-secondary nav-track"
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    ...
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <strong><?php _e( 'Verizon', 'dicenews2015' ); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
