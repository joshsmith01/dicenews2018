<div id="employers_male" class="top-employers employers_male hidden">
    <div class="grid-x">
        <div class="small-12 cell">
            <h3><?php _e( 'Male Top 10', 'dicenews2015' ); ?> </h3>
            <p><?php _e( 'The 10 most popular companies that US-based male professionals would ideally like to work for.', 'dicenews2015' ); ?></p>
...
<div class="grid-x">
    <div class="small-12 cell">
        <h4><?php _e( 'Employer Rankings – Male Top 10', 'dicenews2015' ); ?></h4>
        <div class="ranked-employers">
                ...
                <div class="card-block">
                    ...
                    <div class="employer-logo">
                            ...
                            <img width="150" height="150"
                                 ...
                                 class="attachment-thumb size-thumb" alt="Disney logo">
            ...
            <div class="card-efc card employer-card">
                <div class="card-block">
                    <div class="employer-rank">
                        <div class="font-display text-center large-only-text-left">
                            <a href="https://www.dice.com/company/delliirc" target="_blank"><b><?php _e( 'Rank #10', 'dicenews2015' ); ?></b></a>
                        </div>
                        <div class="font-caption text-center large-only-text-left">
                        </div>
                    </div>
                    <div class="employer-logo">
                        <a href="https://www.dice.com/company/delliirc" target="_blank">
                            <img width="150" height="150"
                                 ...
                                 class="attachment-thumb size-thumb" alt="Space X logo">
                        </a>
                    </div>
                    <div class="employer-info">
                        <div class="employer-name font-headline">
                            <strong><a href="https://www.dice.com/company/delliirc" target="_blank"><?php _e( 'Space X', 'dicenews2015' ); ?></a></strong>
                        </div>
                    </div>
